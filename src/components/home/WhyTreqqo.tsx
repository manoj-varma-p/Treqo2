...
export default function WhyTreqqo() {
  return (
    <section id="method" className="relative z-0 overflow-hidden bg-[#13072E] bg-gradient-to-b from-[#13072E] via-[#1a0b3e] to-[#0e0424] py-16 sm:py-20 lg:py-24 scroll-mt-16 sm:scroll-mt-20">
      {/* Background ambient glows */}
      <div aria-hidden="true" className="pointer-events-none absolute inset-0 -z-10">
        <div className="absolute top-0 left-1/4 h-[400px] w-[400px] rounded-full bg-[#3A1494]/30 blur-3xl" />
        <div className="absolute right-0 bottom-0 h-[450px] w-[450px] rounded-full bg-[#7C3AED]/20 blur-3xl" />
      </div>
      ...
      <Container>
        ...
        <div className="mt-12 grid grid-cols-1 gap-6 lg:grid-cols-12 lg:gap-6 lg:items-stretch">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:col-span-8">
            {submissions.map((item) => (
              <div
                key={item.tag}
                className="flex flex-col justify-between rounded-2xl border border-purple-900/50 bg-[#1c0d42]/80 p-6 shadow-xs backdrop-blur-xs transition-colors hover:border-purple-700/60"
              >
                <div>
          ...
          <div className="flex min-h-[260px] flex-col items-center justify-center rounded-2xl border border-dashed border-purple-800/60 bg-[#1c0d42]/40 p-6 text-center lg:col-span-4">
            <span className="text-[10px] sm:text-xs font-bold uppercase tracking-widest text-purple-300/80 leading-relaxed">
        ...
        {/* Bottom Banner Card */}
        <div className="mt-6 flex flex-col justify-between gap-4 rounded-2xl border border-purple-800/50 bg-[#1c0d42]/90 p-6 sm:p-8 lg:flex-row lg:items-center shadow-xs">
