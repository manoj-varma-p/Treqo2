...
export default function AnnouncementBanner() {
  return (
    <div className="w-full bg-[#0a0c10] py-2 px-4 text-center text-xs sm:text-sm text-white">
      <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-center gap-2 sm:gap-3">
        <span className="inline-flex items-center rounded-md bg-[#FBBF24] px-2.5 py-0.5 text-[11px] font-black uppercase tracking-wider text-black">
